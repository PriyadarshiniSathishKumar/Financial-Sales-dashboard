...
st.set_page_config(page_title="Financial Sales Dashboard", page_icon=":bar_chart:", layout="wide")
...
def load_data(path: str):
    df = pd.read_excel(r"C:\Users\priya\OneDrive\Documents\projects\Streamlit\Project 2\Financial Data Clean.xlsx")
    return df
